...
import "./AquariusStakingProxy.sol";
...
contract AquariusStaking is AquariusStakingG1Storage {
    ...
    function initialize(
        ...
        require(address(stakingToken) == address(0), "AquariusStaking:initialize: Already initialized");
    ...
    function _become(AquariusStakingProxy stakingProxy) public {
