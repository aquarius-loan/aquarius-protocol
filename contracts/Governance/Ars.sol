...
// File contracts/token/oft/v2/mocks/AquariusOFT.sol
...
contract AquariusOFT is OFTV2 {
    ...
    constructor(address _layerZeroEndpoint, uint _initialSupply, uint8 _sharedDecimals) OFTV2("Aquarius", "ARS", _sharedDecimals, _layerZeroEndpoint) {
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) public {
        ...
        require(block.timestamp <= expiry, "Ars::delegateBySig: signature expired");
