...
contract CEvil is AErc20Scenario {
    constructor(address underlying_,
                ComptrollerInterface comptroller_,
                InterestRateModel interestRateModel_,
                uint initialExchangeRateMantissa_,
...
contract AErc20DelegatorScenario is AErc20Delegator {
    constructor(address underlying_,
                ComptrollerInterface comptroller_,
                InterestRateModel interestRateModel_,
                uint initialExchangeRateMantissa_,
...
contract AErc20DelegateHarness is AErc20Delegate {
...
contract AErc20DelegateScenarioExtra is AErc20DelegateScenario {
